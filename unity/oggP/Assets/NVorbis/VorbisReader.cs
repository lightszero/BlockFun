...
namespace NVorbis
{
    public class VorbisReader : IDisposable
    {
            ...
            : this()
        {
            ...
            if (_decoders.Count == 0) throw new Exception("No Vorbis data found!");
        }
            ...
            : this()
        {
            ...
            {
                throw new Exception("Container did not initialize!");
            }
            ...
            : this()
        {
            ...
            NewStream(this, ea);
            if (ea.IgnoreStream) throw new Exception("No Vorbis data found!");
        }
